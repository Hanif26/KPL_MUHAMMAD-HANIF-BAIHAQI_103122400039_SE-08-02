...
// Membungkus pengujian error agar tidak menghentikan program
const testInputs = [null, NaN, Infinity];

testInputs.forEach(input => {
    try {
        console.log(is_not_fizzbuzz(input));
    } catch (error) {
        console.log(`Tertangkap Error: ${error.message}`);
    }
});